"use strict";exports.id=9648,exports.ids=[9648],exports.modules={27267:(a,b,c)=>{c.r(b),c.d(b,{EmbeddedWalletCreatedScreen:()=>l,EmbeddedWalletCreatedScreenView:()=>k,default:()=>l});var d=c(66150),e=c(73782),f=c(7719),g=c(2808),h=c(50579),i=c(67331),j=c(99062);c(19078),c(11765),c(43132);let k=({title:a,description:b,onClose:c})=>(0,d.jsx)(j.S,{title:a,subtitle:b,icon:e.A,iconVariant:"success",watermark:!0,onBack:c}),l={component:()=>{let{user:a}=(0,g.u)(),{closePrivyModal:b,isNewUserThisSession:c,updateWallets:e}=(0,i.u)(),{data:j,onUserCloseViaDialogOrKeybindRef:l}=(0,g.a)(),m=(0,h.u)(),{onSuccess:n,onFailure:o,callAuthOnSuccessOnClose:p}=j.createWallet,q=()=>{let c=(0,g.c)(a)??(0,g.d)(a);a&&c?(e(),n({user:a,account:c})):o(Error("Failed to create wallet")),b({shouldCallAuthOnSuccess:p})};return(0,f.useEffect)(()=>{let a=setTimeout(q,h.r);return()=>clearTimeout(a)},[]),l.current=q,(0,d.jsx)(k,{title:c?"Welcome"+(m?.name?` to ${m?.name}`:""):"All set!",description:c?"You've successfully created an account.":"Your account is secured.",onClose:q})}}},45172:(a,b,c)=>{c.d(b,{S:()=>w});var d=c(66150),e=c(7719),f=c(72291),g=c(69712),h=c(55164),i=c(59656);let j=f.I4.div`
  /* spacing tokens */
