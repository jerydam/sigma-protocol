"use strict";exports.id=8003,exports.ids=[8003],exports.modules={8003:(a,b,c)=>{c.r(b),c.d(b,{WalletInterstitialScreen:()=>i,WalletInterstitialScreenView:()=>h,default:()=>i});var d=c(66150),e=c(7719),f=c(2808),g=c(99062);c(19078),c(11765),c(43132);let h=({title:a,subtitle:b,buttonText:c,buttonHref:e,isLoading:f=!1,helpText:h,onButtonClick:i})=>(0,d.jsx)(g.S,{title:a,subtitle:b,primaryCta:{label:c,onClick:()=>{e&&window.open(e,"_self"),i?.()},disabled:f},helpText:h,watermark:!0}),i={component:()=>{let{ready:a}=(0,f.u)(),{data:b}=(0,f.a)(),[c,g]=(0,e.useState)(!1);if(!b?.installWalletModalData)throw Error("Wallet data is missing");let{walletConfig:i,connectOnly:j,chainType:k}=b.installWalletModalData,l=i.getMobileRedirect({useUniversalLink:!c,isSolana:"solana"===k,connectOnly:j}),m=i.name.replace(/ wallet/gi,""),n={title:`Redirecting to ${m} Mobile Wallet`,description:`We'll take you to the ${m} Mobile Wallet app to continue your login experience.`,footnote:""};return a&&(n.description=`For the best experience, we'll automatically log you into the ${m} Mobile Wallet in-app browser.`,n.footnote="You can always return here to login via other methods."),c&&(n.title="Still here?",n.description=`You may need to install the ${i.name} mobile app.`,n.footnote=`Once you're done, you can connect with ${i.name} wallet to complete the login.`),(0,d.jsx)(h,{title:n.title,subtitle:n.description,buttonText:c?"Go to App Store":"Continue",buttonHref:l,isLoading:a&&!l,helpText:n.footnote||void 0,onButtonClick:()=>{setTimeout(()=>g(!0),1e3)}})}}},45172:(a,b,c)=>{c.d(b,{S:()=>w});var d=c(66150),e=c(7719),f=c(72291),g=c(69712),h=c(55164),i=c(59656);let j=f.I4.div`
  /* spacing tokens */
