"use strict";exports.id=6905,exports.ids=[6905],exports.modules={16905:(a,b,c)=>{c.r(b),c.d(b,{AccountNotFoundScreen:()=>k,AccountNotFoundScreenView:()=>j,default:()=>k});var d=c(66150);let e=(0,c(70958).A)("circle-question-mark",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);var f=c(50579),g=c(67331),h=c(2808),i=c(99062);c(7719),c(19078),c(11765),c(43132);let j=({title:a="Account not found",subtitle:b,appName:c="this app",ctaText:f="Try logging in again",onRetry:g})=>(0,d.jsx)(i.S,{title:a,subtitle:b||`Please try logging in again or go to ${c} to create an account.`,icon:e,iconVariant:"warning",primaryCta:{label:f,onClick:g},watermark:!0}),k={component:()=>{let{navigate:a,setModalData:b,data:c}=(0,h.a)(),e=(0,f.u)(),{getAuthMeta:i,client:k}=(0,g.u)();return(0,d.jsx)(j,{appName:e?.name,onRetry:()=>{let d=i();b({...c,login:{...c?.login,...d?.disableSignup?{disableSignup:!0}:{}}}),k?.authFlow&&(k.authFlow=void 0),a("LandingScreen")}})}}},45172:(a,b,c)=>{c.d(b,{S:()=>w});var d=c(66150),e=c(7719),f=c(72291),g=c(69712),h=c(55164),i=c(59656);let j=f.I4.div`
  /* spacing tokens */
