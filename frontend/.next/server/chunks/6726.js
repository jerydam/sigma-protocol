"use strict";exports.id=6726,exports.ids=[6726],exports.modules={6726:(a,b,c)=>{c.r(b),c.d(b,{PasskeyStatusScreen:()=>n,PasskeyStatusScreenView:()=>m,default:()=>n});var d=c(66150),e=c(67669),f=c(7719),g=c(72291),h=c(50579),i=c(67331),j=c(2808),k=c(97380),l=c(99062);c(19078),c(43132),c(11765),c(30443),c(8752);let m=({status:a,passkeySignupFlow:b=!1,error:c,onRetry:f})=>(0,d.jsx)(l.S,{title:(()=>{switch(a){case"loading":return"Waiting for passkey";case"success":return"Success";case"error":return"Something went wrong"}})(),subtitle:(0,d.jsx)(o,{children:(()=>{switch(a){case"loading":return b?"Please follow prompts to register your passkey.":"Please follow prompts to verify your passkey.\nYou will have to sign up with another method first to register a passkey for your account.";case"success":return"You've successfully logged in with your passkey.";case"error":if(c instanceof i.c){if(c.privyErrorCode===i.b.CANNOT_LINK_MORE_OF_TYPE)return"Cannot link more passkeys to account.";if(c.privyErrorCode===i.b.PASSKEY_NOT_ALLOWED)return"Passkey request timed out or rejected by user.\nYou will have to sign up with another method first to register a passkey for your account."}return"An unknown error occurred.\nYou will have to sign up with another method first to register a passkey for your account."}})()}),icon:e.A,iconVariant:"loading",iconLoadingStatus:{success:"success"===a,fail:"error"===a},primaryCta:"error"===a&&f?{label:"Retry",onClick:f}:"success"===a?{label:"Continue",disabled:!0}:void 0,watermark:!0}),n={component:()=>{let{data:a,setModalData:b,navigate:c}=(0,j.a)(),e=(0,h.u)(),{loginWithPasskey:g,signupWithPasskey:l,closePrivyModal:n,createAnalyticsEvent:o}=(0,i.u)(),{user:p,logout:q}=(0,j.u)(),{passkeySignupFlow:r}=a?.passkeyAuthModalData??{},s=h.q-500,[t,u]=(0,f.useState)("loading"),[v,w]=(0,f.useState)(null),x=(0,f.useRef)([]),y=a=>{x.current=[a,...x.current]};(0,f.useEffect)(()=>()=>{x.current.forEach(a=>clearTimeout(a)),x.current=[]},[]);let z=async()=>{u("loading");try{r?await l():await g(),u("success")}catch(a){w(a),u("error")}};return(0,f.useEffect)(()=>{if("success"===t&&p){if(e?.legal.requireUsersAcceptTerms&&!p.hasAcceptedTerms)return void y(setTimeout(()=>{c("AffirmativeConsentScreen")},s));if(!(0,k.s)(p,e?.embeddedWallets))return void y(setTimeout(()=>{n({shouldCallAuthOnSuccess:!0,isSuccess:!0})},h.q));y(setTimeout(()=>{b({createWallet:{onSuccess:()=>{},onFailure:a=>{console.error(a),o({eventName:"embedded_wallet_creation_failure_logout",payload:{error:a,screen:"PasskeyStatusScreen"}}),q()},callAuthOnSuccessOnClose:!0}}),c("EmbeddedWalletOnAccountCreateScreen")},s))}},[p,t]),(0,f.useEffect)(()=>{z()},[]),(0,d.jsx)(m,{status:t,passkeySignupFlow:r,error:v,onRetry:z})}},o=g.I4.span`
