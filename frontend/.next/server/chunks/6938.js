"use strict";exports.id=6938,exports.ids=[6938],exports.modules={36938:(a,b,c)=>{c.r(b),c.d(b,{DelegatedActionsRevokeScreen:()=>n,DelegatedActionsRevokeScreenView:()=>m,default:()=>n});var d=c(66150),e=c(65947),f=c(73782);let g=(0,c(70958).A)("ban",[["path",{d:"M4.929 4.929 19.07 19.071",key:"196cmz"}],["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}]]);var h=c(7719),i=c(50579),j=c(67331),k=c(2808),l=c(99062);c(19078),c(11765),c(43132);let m=({appName:a,success:b,error:c,onRevoke:h,onDeny:i,onClose:j})=>(0,d.jsx)(l.S,b||c?{title:c?"Something went wrong":"Success!",subtitle:c?"Please try again.":"You've successfully revoked permissions.",icon:c?e.A:f.A,iconVariant:c?"error":"success",onBack:j,watermark:!0}:{title:"Revoke offline access to wallet",subtitle:`By confirming, ${a} will no longer be able to use this wallet on your behalf when you are not online.`,icon:g,primaryCta:{label:"Confirm",onClick:h},secondaryCta:{label:"Deny",onClick:i},onBack:j,watermark:!0}),n={component:()=>{let{data:a}=(0,k.a)(),b=(0,i.u)(),{closePrivyModal:c}=(0,j.u)(),[e,f]=(0,h.useState)(!1),[g,l]=(0,h.useState)(),{onRevoke:n,onSuccess:o,onError:p}=a.delegatedActions.revoke,q=async()=>{e?o():p(g??new j.a("User declined revoking access to their delegated wallet.")),c({shouldCallAuthOnSuccess:!1})};return(0,h.useEffect)(()=>{if(!e&&!g)return;let a=setTimeout(q,i.r);return()=>clearTimeout(a)},[e,g]),(0,d.jsx)(m,{appName:b.name,success:e,error:g,onRevoke:async()=>{try{await n(),f(!0)}catch(a){l(a)}},onDeny:()=>{q()},onClose:q})}}},45172:(a,b,c)=>{c.d(b,{S:()=>w});var d=c(66150),e=c(7719),f=c(72291),g=c(69712),h=c(55164),i=c(59656);let j=f.I4.div`
  /* spacing tokens */
