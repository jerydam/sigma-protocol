...
`},67466:(e,r,i)=>{i.r(r),i.d(r,{LinkPhoneScreen:()=>u,LinkPhoneScreenView:()=>p,default:()=>u});var n=i(73788),t=i(19579),a=i(65936),o=i(2685),l=i(75187),s=i(86249),c=i(79312),d=i(22404);i(28349),i(7764),i(30404);let p=({title:e="Connect your phone",subtitle:r="Add your number to your account",onSubmit:i,isSubmitting:l=!1})=>{let[s,c]=(0,a.useState)(null),p=async()=>{s?.qualifiedPhoneNumber&&await i(s)};return(0,n.jsx)(d.S,{title:e,subtitle:r,icon:t.A,primaryCta:{label:l?"Submitting":"Submit",onClick:p,disabled:!s?.isValid||l},watermark:!0,children:(0,n.jsx)(o.C,{onChange:e=>{c(e)},onSubmit:p,noIncludeSubmitButton:!0,hideRecent:!0})})},u={component:()=>{let{currentScreen:e,data:r,navigate:i,setModalData:t}=(0,c.a)(),o=(0,l.u)(),{initLoginWithSms:d}=(0,s.u)(),[u,h]=(0,a.useState)(!1);return(0,n.jsx)(p,{subtitle:`Add your number to your ${o?.name} account`,onSubmit:async n=>{h(!0);try{await d({phoneNumber:n.qualifiedPhoneNumber,withPrivyUi:!0}),i("AwaitingPasswordlessCodeScreen")}catch(n){t({errorModalData:{error:n,previousScreen:r?.errorModalData?.previousScreen||e||"LinkPhoneScreen"}}),i("ErrorScreen")}finally{h(!1)}},isSubmitting:u})}}},94217:(e,r,i)=>{i.d(r,{S:()=>j});var n=i(73788),t=i(65936),a=i(78912),o=i(41196),l=i(74124),s=i(66656);let c=a.I4.div`
  /* spacing tokens */
